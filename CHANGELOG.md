...
- **The project now says plainly where its comic data came from, and no longer claims a licence
  ...
  and the only thing that changes on screen is three sentences on the About page that were saying
  the wrong thing. One of them told you the bundled reading lists were not put together here, when
  most of them are. The comic details shown in the app were never written here:
