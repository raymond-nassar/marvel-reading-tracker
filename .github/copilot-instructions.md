...
- **The `absent:` exemption reaches past its own clause, and what it swallows is dropped in
  ...
  its own token, the form used at `PRODUCT_BACKLOG.md:6332`. The tell is the exempt count the gate
...
ending in `lib/puppeteer/puppeteer-core.js`. `docs/UX_STUDY.md:914-916` records that choice and the
