...
Do not narrow that to a list of filenames. `scripts/check-anchors.mjs:192-195` explains why in the
...
ending in `lib/puppeteer/puppeteer-core.js`. `docs/UX_STUDY.md:909-911` records that choice and the
