...
| 1.3 | BL-003 | P1 | search form at `src/index.html:410-416`, search-as-you-type at `src/js/main.js:3104-3119` | Done |
...
| 4.2 | BL-014 | P1 | the progress view is scoped to the active list at `src/js/main.js:3286-3320`, with a scope control at `src/index.html:377-381` and a subtitle that stops claiming every list at `src/js/main.js:3300-3302` | Done, shipped as BL-014 |
...
still. The maintainability gap at `PRODUCT_BACKLOG.md:9913-9915` uses that size as the argument for
...
`Resolved:` line rather than editing the bullet it resolves, at `PRODUCT_BACKLOG.md:9932-9936`.
Overwriting would have destroyed the audit trail these sections exist to keep.

So the audited figures stand and each now carries its drift. Two of the three statements were
treated as live and one was not. The outcome narrative at `PRODUCT_BACKLOG.md:9747-9749` describes
...
`CHANGELOG.md:2322-2331` that says so and points at the backlog clause instead. That clause was
...
`src/index.html:121-122`, `src/js/main.js:3783-3846`.
...
- Gap: series progress is computed across every list at once rather than for the list being read,
  ...
  Evidence: `src/js/main.js:3286-3320` (renderProgress, which now takes a scope), `src/index.html:375`
  (the view's subtitle).
