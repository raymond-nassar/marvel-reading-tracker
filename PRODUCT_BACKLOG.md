...
| 2.4 | BL-008 | P1 | orders and catalog generated by `scripts/vendor-orders.mjs:194-327`, consumed as data with no view change | Done |
...
`scripts/vendor-orders.mjs:48` and `scripts/build-event-order.mjs:209`, and none of them used the
...
`scripts/vendor-orders.mjs:219-272`, `scripts/vendor-orders.mjs:326`.
...
`scripts/vendor-orders.mjs:257-263`.
...
two readings had to win: `scripts/vendor-orders.mjs:310-312` warns that a repeated id will collapse on
