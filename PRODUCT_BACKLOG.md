...
| 4.5 | BL-017 | P2 | notes on both shapes at `src/js/lib/model.js:543-572`, quoted into the Markdown export at `src/js/lib/markdown.js:177-179` | Done, shipped as BL-017 |
...
* The test count is 224 passing, not the 119 recorded in `.copilot-tracking/changes/`. Evidence:
  ...
  it to 716; 224 is the figure as audited.
...
`CHANGELOG.md:1458-1467` that says so and points at the backlog clause instead. That clause was
