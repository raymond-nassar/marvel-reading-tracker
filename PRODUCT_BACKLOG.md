...
BL-145, BL-146, BL-147, BL-148 and BL-149.
...
|-------|-----|-------------------|-------------------|-------------|
| 1.1 | BL-001 | P0 | catalogRow renders name, type, count and description at `src/js/main.js:3250-3311` | Done |
| 1.2 | BL-002 | P0 | catalog filter fieldset at `src/index.html:425-427`, filterByFacet imported at `src/js/main.js:19` | Done |
| 1.3 | BL-003 | P1 | search form at `src/index.html:418-424`, search-as-you-type at `src/js/main.js:3372-3387` | Done |
| 1.4 | BL-004 | P1 | depth pill rendered before the Import button at `src/js/main.js:3274` and `src/js/main.js:3292-3309` | Done |
...
| 2.2 | BL-006 | P0 | attributionLine renders source and snapshot date at `src/js/main.js:3350-3370` | Done |
...
| 3.1 | BL-009 | P0 | parseChecklist and the import report at `src/js/main.js:2961-3017`, `src/js/lib/markdown.js:36-115` | Done |
...
| 3.3 | BL-011 | P1 | series and creator adds at `src/js/main.js:2923-2941`, manual issue add at `src/js/main.js:3096-3140` | Done |
...
| 4.2 | BL-014 | P1 | the progress view is scoped to the active list at `src/js/main.js:3554-3588`, with a scope control at `src/index.html:385-389` and a subtitle that stops claiming every list at `src/js/main.js:3568-3570` | Done, shipped as BL-014 |
...
| 4.5 | BL-017 | P2 | notes on both shapes at `src/js/lib/model.js:674-703`, quoted into the Markdown export at `src/js/lib/markdown.js:180-182` | Done, shipped as BL-017 |
...
| 5.3 | BL-020 | P1 | manual entries carry `source: 'manual'` at `src/js/main.js:3119` and render, reorder, export and back up like any other issue | Done |
...
| 6.2 | BL-023 | P1 | same backup file restores on another browser, validated and atomic, with undo at `src/js/main.js:3781-3787` | Done |
...
* `src/js/main.js` is 1,566 lines, not 1,543, by `(Get-Content).Count` and confirmed by the last <!-- sizes:frozen -->
  line number when reading the file. Evidence: `src/js/main.js:4131-4151`. The work shipped since has
  taken it further: the file is 4,239 lines today. 1,566 is the figure as audited.
...
* The test count is 224 passing, not the 119 recorded in `.copilot-tracking/changes/`. Evidence:
  ...
  it to 1,136; 224 is the figure as audited.
...
| BL-149 | Stop collapsing the sidebar from blanking every pill in the catalog | Defect | EP-08 | Follows BL-148 | 3 | 2 | 2 | 1 | 7.0 | none | Measured | Shipped | `src/styles.css:347-348` |
...
| BL-087 | State the network privacy boundary where the promise appears | Debt | EP-05 | Leaves alone | 5 | 3 | 3 | 2 | 5.5 | none | Measured | Shipped | src/index.html:517 |
...
| BL-101 | Withdraw the undo-restore offer when erasing everything | Defect | EP-06 | Follows BL-083 | 5 | 3 | 3 | 2 | 5.5 | none | Measured | Shipped | src/js/main.js:3830-3867 |
| BL-085 | Bound backup restore before parsing and persistence | Enabler | EP-06 | Extends BL-022 | 5 | 3 | 8 | 3 | 5.33 | none | Measured | Shipped | src/js/main.js:3742-3770 |
...
| BL-148 | Say which order to read after this one, for a reader who has read none of them | Story | EP-01 | Extends BL-143 | 8 | 3 | 5 | 3 | 5.33 | none | Measured | Shipped | absent: any field, prose or rendering that puts two orders in sequence, read of the manifest field set and of every line the catalog row draws |
...
| BL-107 | Date or re-derive the repeat figures BL-058 states as current | Debt | EP-12 | Extends BL-059 | 2 | 1 | 2 | 1 | 5.0 | none | Measured | Shipped | PRODUCT_BACKLOG.md:3907-3910 |
...
| BL-150 | Shelve the events apart from the character runs, and say why the runs sit last | Story | EP-01 | Follows BL-148 | 5 | 3 | 2 | 2 | 5.0 | none | Measured | Ready | `src/js/main.js:3236-3237` |
...
| BL-121 | Point the three erase-and-restore citations at three different lines | Debt | EP-12 | Extends BL-101 | 2 | 1 | 2 | 1 | 5.0 | none | Measured | Shipped | PRODUCT_BACKLOG.md:1400-1401 |
...
| BL-124 | Stop the rate-limit backoff saying the same wait twice, and say it grammatically | Defect | EP-07 | Extends BL-090 | 2 | 1 | 2 | 1 | 5.0 | none | Measured | Shipped | src/js/main.js:4104-4107 |
...
| BL-090 | Announce passive service, cache and hydration status changes once | Defect | EP-07 | Extends BL-027 | 3 | 2 | 3 | 2 | 4.0 | none | Measured | Shipped | src/js/main.js:4051-4114 |
...
| BL-110 | Count the issues an order imported empty, and say so | Defect | EP-05 | Extends BL-009 | 3 | 2 | 3 | 2 | 4.0 | none | Measured | Shipped | src/js/main.js:3511 |
...
| BL-014 | Count series progress for the list being read | Story | EP-04 | Leaves alone | 5 | 2 | 2 | 3 | 3.0 | P1 | Observed | Shipped | src/js/main.js:3554-3588 |
...
| BL-119 | Show an order's gap on the catalog row, before it is imported | Story | EP-05 | Follows BL-110 | 3 | 1 | 2 | 3 | 2.0 | none | Measured | Ready | src/js/main.js:3264-3269 |
...
| BL-151 | Draw the reading path as a path, instead of a badge on each row of a list | Story | EP-01 | Follows BL-148 | 5 | 1 | 3 | 5 | 1.8 | none | Measured | Ready | `src/js/main.js:3329-3344` |
...
| BL-033 | Re-render only what changed when an issue is marked read | Debt | EP-09 | Leaves alone | 5 | 2 | 5 | 8 | 1.5 | none | Measured | Shipped | src/js/main.js:4131-4145 |
...
| BL-042 | Break the single view file into per-view modules | Debt | EP-12 | Leaves alone | 2 | 1 | 8 | 20 | 0.55 | none | Measured | Proposed | src/js/main.js:4131-4145 |
...
that function is at `src/js/main.js:3174` today, with the rename-list handler occupying the lines the
...
real title is `.result-title`, written at `src/js/main.js:3298`, and with the selector corrected the
...
`src/js/main.js:3568-3570` instead of asserting "every list" whatever is being counted.
...
The About view carries the shortcut reference at `src/index.html:643-650`, naming all three
...
`.badge-expected` at 1.58:1, but that is unconditional design at `src/styles.css:481` rather than
...
`src/index.html:768`, so resolving the theme in JavaScript would paint dark and then flip, and
...
`src/js/main.js:3514`. The same order can be added from the landing page and imported from the
...
about to make at `src/js/main.js:3514`, because two announcements in one tick leave only the last.
...
rolls the half-import back at `src/js/main.js:3483-3494`, leaving nothing behind and the offer still
...
`src/js/main.js:3841`, `src/js/main.js:3765` and `src/js/main.js:3781-3787`. Each replaces the whole
...
in `src/js/lib/library.js:27-51` and rendered by a single function at `src/js/main.js:3595-3613`.
...
The settings form keeps its own check and its own message at `src/js/main.js:3792-3793`, unchanged.
...
two at `src/index.html:523` and `src/index.html:530` are direct children of a `.card card-static`,
...
unconditional design at `src/styles.css:481`, where the border is 25 percent alpha green.
...
drop in. `importCurated` sets `btn.disabled = true` at `src/js/main.js:3456`, and disabling a focused
...
time after a 1500 ms `setTimeout`, and the re-enable in its `finally` at `src/js/main.js:3531` puts
...
`src/js/main.js:4131` calls both on every `store.update` with no navigation at all. Measured on that
...
sequence moved into an exported `boot()` at `src/js/main.js:4164`, and `src/js/app.js` is the entry
...
confirm dialog at `src/index.html:762`. The convention there is the same shape as this: the action
...
that boot report, and the comment now standing in its place at `src/js/main.js:4211-4215` records
...
file of 4,239 lines wires a store, a metadata client, a rate limiter, a response cache and a hydrator
...
the client and leaves the limiter alone, at `src/js/main.js:3804-3806`, because the budget belongs to
...
still. The maintainability gap at `PRODUCT_BACKLOG.md:10808-10810` uses that size as the argument for
...
`Resolved:` line rather than editing the bullet it resolves, at `PRODUCT_BACKLOG.md:10827-10831`.
Overwriting would have destroyed the audit trail these sections exist to keep.

So the audited figures stand and each now carries its drift. Two of the three statements were
treated as live and one was not. The outcome narrative at `PRODUCT_BACKLOG.md:10642-10644` describes
...
`CHANGELOG.md:2699-2708` that says so and points at the backlog clause instead. That clause was
...
`src/js/storage.js:495-571`, `src/js/main.js:3742-3770`.
...
already represents, which is why the size is 3 rather than 2. Evidence: `src/js/main.js:3264-3269`,
...
attack. Evidence: `src/js/main.js:3742-3770`, `src/js/lib/model.js:965-1074`.
...
`src/js/lib/model.js:225-240`, `server.mjs:53-59`, `src/index.html:540-545`.
...
remain local or absent. Evidence: `README.md:84-103`, `src/index.html:514-572`,
...
at once. The About view's "Metadata and links only" card, at `src/index.html:617-621`, is the sixth,
...
`src/index.html:125-126`, `src/js/main.js:4051-4114`.
...
size, at `PRODUCT_BACKLOG.md:2495`, and one of the four tests added to the counts suite pins the
...
button at `src/js/main.js:3830-3867` and the escape hatch out of the blocked state at
...
the answer is handed to the caller. The screen at `src/js/main.js:3837-3866` repaints the banner
...
and `src/styles.css:436` sets `background-image: none` under the same class, which does suppress a
...
button. Evidence: `src/js/main.js:3473-3479`, `src/js/lib/model.js:211`,
...
report the one kind this repository does not currently have. Evidence: `src/js/main.js:3505-3511`,
...
here. Evidence: `src/js/main.js:3520`.
...
in place of that button while a copy is live at `src/js/main.js:3954-3960`, which is the state a
...
wrong. Evidence: `PRODUCT_BACKLOG.md:4730-4738`.
...
`forgetDeleted()`, at `src/js/main.js:3841`, `src/js/main.js:3765` and `src/js/main.js:3786`
respectively, but the sentence cited the restore path twice and the erase path not at all. Evidence:
`PRODUCT_BACKLOG.md:1400-1401`.
...
**Delivered.** The first citation now names `src/js/main.js:3841`, which is the `forgetDeleted()`
call inside the erase handler at `src/js/main.js:3830-3867`. The other two were already right and
are unchanged: `src/js/main.js:3765` is the call in the successful branch of the restore handler,
and `src/js/main.js:3781-3787` is the whole undo-restore handler, whose call is at
`src/js/main.js:3786`. The range was left as the handler rather than narrowed to the call, because
...
`forgetDeletedFor`, `src/js/main.js:3514` is its one call, `src/js/main.js:3483-3494` is the
...
at `PRODUCT_BACKLOG.md:4735-4736`.
...
the two shapes it named as unchecked at `PRODUCT_BACKLOG.md:4730-4733` are the counts of items above
...
faults were on one line, inside `onApiStatus` at `src/js/main.js:4104-4107`.
...
lets the repeat through in both directions. `backoffAnnouncer` at `src/js/main.js:4086-4100` keeps
...
**BL-148: Say which order to read after this one, for a reader who has read none of them**
...
tree, because `--card-2` already carried two other foregrounds.

**BL-149: Stop collapsing the sidebar from blanking every pill in the catalog**
...
**BL-150: Shelve the events apart from the character runs, and say why the runs sit last**
...
**BL-151: Draw the reading path as a path, instead of a badge on each row of a list**
...
BL-148 answers "what do I read after this" on the row a reader is already looking at. It does not
...
- Gap: series progress is computed across every list at once rather than for the list being read,
  ...
  Evidence: `src/js/main.js:3554-3588` (renderProgress, which now takes a scope), `src/index.html:383`
  (the view's subtitle).
...
- Gap: the catalog carries a variant grouping model, but only the Hickman creator run populates it.
  ...
  `src/js/main.js:3299` (groupCatalog renders variant rows only where a group exists).
...
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:4131-4151` (renderAll rebuilds
...
- User error protection: no gap, closed by BL-034 and BL-035. Deleting a list is confirmed in the
  ...
  `src/js/main.js:1969-1996` (undo), `src/js/main.js:3781-3787` (undoRestore exists).
...
- Modularity gap: `src/js/main.js` is 1,566 lines and carries every view, every event handler and <!-- sizes:frozen -->
  ...
  Evidence: `src/js/main.js:4131-4151`, `src/js/main.js:966-983` (showView switches views by
  mutating a module-level variable).
  Still open, and wider than audited: the file is 4,239 lines now, so nearly every item shipped
...
- Replaceability: good. The metadata API base URL is user-configurable and validated, the cache is
  ...
  Evidence: `src/js/main.js:3789-3822`, `src/js/lib/cachePolicy.js:16-20`,
...
| Data durability and export | No gap. Full JSON backup and restore, per-list Markdown export, validated and atomic restore with an undo. Evidence: `src/js/lib/model.js:1043-1074`, `src/js/main.js:3781-3787`. |
...
| Licensing | No gap. The project is MIT, and every vendored order records its upstream source and licence rather than absorbing it silently. Evidence: `LICENSE`, `src/data/catalog.json` (`source` and `sourceLicense` per list), `src/js/main.js:3350-3370` (attribution rendered in the UI before import). |
...
### Case 1: BL-026 is labelled P0 but ranks sixty-second

- Stated: P0 Foundation, the first keyboard story in the original Epic 7.
- Calculated: WSJF 3.67, rank 62 of 127.
...
- Calculated: WSJF 1.4, rank 121 of 127, below a hundred and seventeen unlabelled items and five places above the
  single P2 story.
- Driver: both sides. Job size is 5, because the work is editorial rather than technical, and value
  ...
  `src/js/main.js:3299` and `src/js/main.js:3292-3309`. What is missing is data, in
...
- BL-014, P1, rank 79 of 127. Mid-table, which is where a P1 belongs.
- BL-027, P1, rank 64 of 127. Mid-table.
- BL-017, P2, rank 126 of 127. The lowest-ranked scored story other than the one that cannot be
