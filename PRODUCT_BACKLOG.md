...
A hundred and thirty-two items have since been delivered and are marked `Shipped` in the table below: BL-007,
...
BL-164, BL-165, BL-166, BL-167, BL-169, BL-170, BL-171, BL-174 and BL-176.
...
| BL-176 | Publish the first guarded modern Marvel event batch | Feature | EP-03 | Follows BL-165 | 8 | 8 | 13 | 5 | 5.8 | none | Measured | Shipped | absent: any bundled order produced from the maintained modern continuity intake before this batch |
...
| BL-107 | Date or re-derive the repeat figures BL-058 states as current | Debt | EP-12 | Extends BL-059 | 2 | 1 | 2 | 1 | 5.0 | none | Measured | Shipped | PRODUCT_BACKLOG.md:4021-4027 |
...
| BL-121 | Point the three erase-and-restore citations at three different lines | Debt | EP-12 | Extends BL-101 | 2 | 1 | 2 | 1 | 5.0 | none | Measured | Shipped | PRODUCT_BACKLOG.md:1520-1525 |
...
still. The maintainability gap at `PRODUCT_BACKLOG.md:12169-12179` uses that size as the argument for
...
`Resolved:` line rather than editing the bullet it resolves, at `PRODUCT_BACKLOG.md:12188-12192`.
Overwriting would have destroyed the audit trail these sections exist to keep.

So the audited figures stand and each now carries its drift. Two of the three statements were
treated as live and one was not. The outcome narrative at `PRODUCT_BACKLOG.md:11999-12005` describes
...
`CHANGELOG.md:3102-3113` that says so and points at the backlog clause instead. That clause was
...
size, at `PRODUCT_BACKLOG.md:2616`, and one of the four tests added to the counts suite pins the
...
wrong. Evidence: `PRODUCT_BACKLOG.md:4853-4861`.
...
at `PRODUCT_BACKLOG.md:4853-4861`.
...
the two shapes it named as unchecked at `PRODUCT_BACKLOG.md:4853-4858` are the counts of items above
...
**BL-176: Publish the first guarded modern Marvel event batch**
...
### Case 1: BL-026 is labelled P0 but ranks eighty-first

- Stated: P0 Foundation, the first keyboard story in the original Epic 7.
- Calculated: WSJF 3.67, rank 81 of 150.
- Driver: job size, not value. Its Cost of Delay of 11 is the thirteenth-highest distinct figure in
  the backlog. It is outranked by eighty items, seventy-six of them sized 1, 2 or 3 whose Cost of Delay
...
- Calculated: WSJF 1.4, rank 144 of 150, below a hundred and forty unlabelled items and five places above the
  single P2 story.
...
- BL-014, P1, rank 100 of 150. Mid-table, which is where a P1 belongs.
- BL-027, P1, rank 83 of 150. Mid-table.
- BL-017, P2, rank 149 of 150. The lowest-ranked scored story other than the one that cannot be
