...
|-------|-----|-------------------|-------------------|-------------|
| 1.1 | BL-001 | P0 | catalogRow renders name, type, count and description at `src/js/main.js:1201-1231` | Done |
| 1.2 | BL-002 | P0 | category fieldset at `src/index.html:214-216`, filterByCategory imported at `src/js/main.js:16` | Done |
| 1.3 | BL-003 | P1 | search form at `src/index.html:207-213`, search-as-you-type at `src/js/main.js:1259-1267` | Done |
| 1.4 | BL-004 | P1 | depth pill rendered before the Import button at `src/js/main.js:1205` and `src/js/main.js:1214-1219` | Done |
...
| 2.2 | BL-006 | P0 | attributionLine renders source and snapshot date at `src/js/main.js:1237-1257` | Done |
| 2.3 | BL-007 | P1 | grouping and variant labelling exist at `src/js/main.js:1184` and `src/js/main.js:1201-1206`, but only the Hickman creator run populates `group` and `variant` in `src/data/catalog.json`; all six event lists carry null | Partial |
...
- Self-descriptiveness: gap. The full availability description is carried only in a `title`
  attribute, which never reaches a keyboard or touch user. Evidence: `src/js/main.js:580`.
...
- Driver: both sides. Job size is 5, because the work is editorial rather than technical, and value
  ...
  `src/js/main.js:1184` and `src/js/main.js:1201-1206`. What is missing is data, in
