...
Thirty-four items have since been delivered and are marked `Shipped` in the table below: BL-007,
...
BL-054, BL-055, BL-056, BL-057, BL-058, BL-059, BL-061, BL-062 and BL-063.
...
`CHANGELOG.md:311-314` that says so and points at the backlog clause instead. That clause was
...
| Data durability and export | No gap. Full JSON backup and restore, per-list Markdown export, validated and atomic restore with an undo. Evidence: `src/js/lib/model.js:543-567`, `src/js/main.js:2570-2576`. |
