...
- `CHANGELOG.md:2106-2109`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2118-2121`, the released note that the private channel is not switched on.
