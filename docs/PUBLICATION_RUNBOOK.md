...
- `CHANGELOG.md:2070-2073`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2082-2085`, the released note that the private channel is not switched on.
