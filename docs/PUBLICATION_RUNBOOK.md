...
reasoning at `PRODUCT_BACKLOG.md:6981-6985`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6333-6346`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6744-6747`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6810-6812`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6833-6837`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6840-6846`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:6907-6913`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:6938-6943`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:6981-6985`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9085-9090`, the three settings named as refused on this repository today.
