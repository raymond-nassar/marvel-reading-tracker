...
- `CHANGELOG.md:1669-1672`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1681-1684`, the released note that the private channel is not switched on.
