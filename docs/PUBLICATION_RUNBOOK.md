...
- `CHANGELOG.md:1766-1769`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1778-1781`, the released note that the private channel is not switched on.
