...
reasoning at `PRODUCT_BACKLOG.md:7070-7074`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6422-6435`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6833-6836`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6899-6901`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6922-6926`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6929-6935`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:6996-7002`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7027-7032`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7070-7074`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9174-9179`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2215-2218`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2227-2230`, the released note that the private channel is not switched on.
