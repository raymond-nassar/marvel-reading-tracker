...
- `CHANGELOG.md:1725-1728`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1737-1740`, the released note that the private channel is not switched on.
