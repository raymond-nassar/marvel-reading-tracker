...
- `CHANGELOG.md:1894-1897`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1906-1909`, the released note that the private channel is not switched on.
