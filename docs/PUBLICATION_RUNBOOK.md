...
- `CHANGELOG.md:1978-1981`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1990-1993`, the released note that the private channel is not switched on.
