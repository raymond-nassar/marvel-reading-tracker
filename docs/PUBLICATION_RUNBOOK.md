...
- `PRODUCT_BACKLOG.md:6414-6427`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6825-6828`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6891-6893`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6914-6918`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6921-6927`, why the code of conduct offers no private channel.
...
- `CHANGELOG.md:2170-2173`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2182-2185`, the released note that the private channel is not switched on.
