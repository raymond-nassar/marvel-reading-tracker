...
- `CHANGELOG.md:1606-1609`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1618-1621`, the released note that the private channel is not switched on.
