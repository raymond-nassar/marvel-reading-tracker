...
- `CHANGELOG.md:1526-1529`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1538-1541`, the released note that the private channel is not switched on.
