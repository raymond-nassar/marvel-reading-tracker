...
- `CHANGELOG.md:1632-1635`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1644-1647`, the released note that the private channel is not switched on.
