...
reasoning at `PRODUCT_BACKLOG.md:6989-6993`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6341-6354`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6752-6755`, why the private reporting task was left open.
...
- `PRODUCT_BACKLOG.md:6848-6854`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:6915-6921`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:6946-6951`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:6989-6993`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9093-9098`, the three settings named as refused on this repository today.
- `CHANGELOG.md:1937-1940`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1949-1952`, the released note that the private channel is not switched on.
