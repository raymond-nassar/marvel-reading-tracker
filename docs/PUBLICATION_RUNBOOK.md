...
- `CHANGELOG.md:1446-1449`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1458-1461`, the released note that the private channel is not switched on.
