...
- `CHANGELOG.md:1953-1956`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1965-1968`, the released note that the private channel is not switched on.
