...
reasoning at `PRODUCT_BACKLOG.md:6944-6948`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6296-6309`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6707-6710`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6773-6775`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6796-6800`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6803-6809`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:6870-6876`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:6901-6906`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:6944-6948`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9048-9053`, the three settings named as refused on this repository today.
- `CHANGELOG.md:1792-1795`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1804-1807`, the released note that the private channel is not switched on.
