...
reasoning at `PRODUCT_BACKLOG.md:7054-7058`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6406-6419`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6817-6820`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6883-6885`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6906-6910`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6913-6919`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:6980-6986`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7011-7016`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7054-7058`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9158-9163`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2164-2167`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2176-2179`, the released note that the private channel is not switched on.

The twelfth was live and did have to change: the introduction at `PRODUCT_BACKLOG.md:27-39` listed
