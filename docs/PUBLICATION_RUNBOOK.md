...
- `CHANGELOG.md:1667-1670`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1679-1682`, the released note that the private channel is not switched on.
