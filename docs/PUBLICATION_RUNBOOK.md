...
- `CHANGELOG.md:1845-1848`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1857-1860`, the released note that the private channel is not switched on.
