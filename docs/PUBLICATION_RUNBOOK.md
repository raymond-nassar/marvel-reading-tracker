...
- `CHANGELOG.md:1839-1842`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1851-1854`, the released note that the private channel is not switched on.
