...
- `CHANGELOG.md:1844-1847`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1856-1859`, the released note that the private channel is not switched on.
