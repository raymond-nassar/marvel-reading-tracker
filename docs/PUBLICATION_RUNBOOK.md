...
- `CHANGELOG.md:1876-1879`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1888-1891`, the released note that the private channel is not switched on.
