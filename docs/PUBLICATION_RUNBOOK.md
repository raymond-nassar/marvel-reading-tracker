...
- `CHANGELOG.md:1840-1843`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1852-1855`, the released note that the private channel is not switched on.
