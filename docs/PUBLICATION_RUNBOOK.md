...
reasoning at `PRODUCT_BACKLOG.md:7088-7092`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6441-6454`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6852-6859`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6918-6920`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6940-6945`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6947-6953`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:7014-7020`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7045-7050`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7088-7092`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9192-9197`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2391-2394`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2403-2406`, the released note that the private channel is not switched on.
