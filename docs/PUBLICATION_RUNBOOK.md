...
- `CHANGELOG.md:1582-1585`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1594-1597`, the released note that the private channel is not switched on.
