...
- `CHANGELOG.md:1649-1652`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1661-1664`, the released note that the private channel is not switched on.
