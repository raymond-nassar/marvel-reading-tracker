...
- `CHANGELOG.md:2261-2263`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2272-2275`, the released note that the private channel is not switched on.
