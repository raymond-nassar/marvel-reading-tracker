...
- `CHANGELOG.md:1932-1935`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1944-1947`, the released note that the private channel is not switched on.
