...
reasoning at `PRODUCT_BACKLOG.md:6982-6986`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6334-6347`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6745-6748`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6811-6813`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6834-6838`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6841-6847`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:6908-6914`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:6939-6944`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:6982-6986`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9086-9091`, the three settings named as refused on this repository today.
- `CHANGELOG.md:1847-1850`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1859-1862`, the released note that the private channel is not switched on.
