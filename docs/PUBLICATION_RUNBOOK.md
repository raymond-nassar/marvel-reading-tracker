...
- `CHANGELOG.md:1816-1819`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1828-1831`, the released note that the private channel is not switched on.
