...
reasoning at `PRODUCT_BACKLOG.md:7080-7084`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6433-6446`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6844-6851`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6910-6912`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6932-6937`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6939-6945`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:7006-7012`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7037-7042`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7080-7084`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9184-9189`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2290-2293`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2302-2305`, the released note that the private channel is not switched on.

The twelfth was live and did have to change: the introduction at `PRODUCT_BACKLOG.md:28-40` listed
