...
- `CHANGELOG.md:1429-1432`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1441-1444`, the released note that the private channel is not switched on.
