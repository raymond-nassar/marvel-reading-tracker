...
- `CHANGELOG.md:1459-1462`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1471-1474`, the released note that the private channel is not switched on.
