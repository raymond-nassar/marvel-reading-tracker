...
- `CHANGELOG.md:1586-1589`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1598-1601`, the released note that the private channel is not switched on.
