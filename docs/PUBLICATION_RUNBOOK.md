...
reasoning at `PRODUCT_BACKLOG.md:7050-7054`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6402-6415`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6813-6816`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6879-6881`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6902-6906`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6909-6915`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:6976-6982`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7007-7012`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7050-7054`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9154-9159`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2135-2138`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2147-2150`, the released note that the private channel is not switched on.
