...
- `CHANGELOG.md:1525-1528`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1537-1540`, the released note that the private channel is not switched on.
