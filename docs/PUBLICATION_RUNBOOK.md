...
- `CHANGELOG.md:1956-1959`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1968-1971`, the released note that the private channel is not switched on.
