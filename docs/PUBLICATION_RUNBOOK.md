...
- `CHANGELOG.md:2016-2019`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2028-2031`, the released note that the private channel is not switched on.
