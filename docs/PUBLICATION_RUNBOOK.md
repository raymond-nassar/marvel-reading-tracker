...
reasoning at `PRODUCT_BACKLOG.md:7084-7088`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6437-6450`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6848-6855`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6914-6916`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6936-6941`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6943-6949`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:7010-7016`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7041-7046`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7084-7088`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9188-9193`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2352-2355`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2364-2367`, the released note that the private channel is not switched on.
