...
interface in exactly one place, at `src/js/main.js:2472`, and the function behind it already
answers for the absence at `src/js/main.js:2660-2669`, with a test asserting the sentence it
