...
interface in exactly one place, at `src/js/main.js:2110`, and the function behind it already
answers for the absence at `src/js/main.js:2294-2303`, with a test asserting the sentence it
