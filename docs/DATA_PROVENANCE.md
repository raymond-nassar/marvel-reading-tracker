...
interface in exactly one place, at `src/js/main.js:2104`, and the function behind it already
answers for the absence at `src/js/main.js:2288-2297`, with a test asserting the sentence it
