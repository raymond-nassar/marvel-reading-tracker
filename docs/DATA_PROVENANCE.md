...
interface in exactly one place, at `src/js/main.js:1917`, and the function behind it already
answers for the absence at `src/js/main.js:2101-2110`, with a test asserting the sentence it
