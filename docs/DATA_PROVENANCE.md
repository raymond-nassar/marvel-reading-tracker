...
`src/index.html:244`. Redistributing Content outside an App, and sublicensing it onward, are the
...
interface in exactly one place, at `src/js/main.js:2064`, and the function behind it already
answers for the absence at `src/js/main.js:2248-2257`, with a test asserting the sentence it
