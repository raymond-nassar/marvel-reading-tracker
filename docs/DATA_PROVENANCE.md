...
`src/index.html:248`. Redistributing Content outside an App, and sublicensing it onward, are the
...
interface in exactly one place, at `src/js/main.js:2182`, and the function behind it already
answers for the absence at `src/js/main.js:2366-2375`, with a test asserting the sentence it
