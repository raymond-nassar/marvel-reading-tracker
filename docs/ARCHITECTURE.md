...
`src/js/main.js:3778-3780`. The hydrator itself is not rebuilt; only its reference to the client is
...
surfaces, the six screens plus the blocked banner, at `src/js/main.js:4105-4125`, but the reading
