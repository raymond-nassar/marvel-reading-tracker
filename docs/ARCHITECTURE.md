...
itself is loaded at `src/index.html:788`. The launch page, which is the tab a reader's issue opens
...
`src/js/main.js:3952-3954`. The hydrator itself is not rebuilt; only its reference to the client is
...
surfaces, the six screens plus the blocked banner, at `src/js/main.js:4279-4299`, but the reading
