...
`src/js/main.js:3938-3940`. The hydrator itself is not rebuilt; only its reference to the client is
...
surfaces, the six screens plus the blocked banner, at `src/js/main.js:4265-4285`, but the reading
