...
itself is loaded at `src/index.html:737`. The launch page, which is the tab a reader's issue opens
...
BL-042 proposes breaking the 3,413 line view file into per-view modules. A diagram drawn at the
