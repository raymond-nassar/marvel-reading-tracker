...
`src/js/main.js:3820-3822`. The hydrator itself is not rebuilt; only its reference to the client is
...
surfaces, the six screens plus the blocked banner, at `src/js/main.js:4147-4167`, but the reading
