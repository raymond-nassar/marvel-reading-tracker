...
`src/js/main.js:3312-3314`. The hydrator itself is not rebuilt; only its reference to the client is
...
`src/js/lib/model.js:588-590`, returns a new state and touches nothing. Everything that decides
