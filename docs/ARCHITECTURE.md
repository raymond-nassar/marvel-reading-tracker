...
`src/js/main.js:3549-3551`. The hydrator itself is not rebuilt; only its reference to the client is
...
surfaces, the six screens plus the blocked banner, at `src/js/main.js:3876-3896`, but the reading
