...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1440-1445` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:61-66`, `src/js/main.js:2445-2458`
...
Confidence: Observed
Evidence: `src/js/main.js:2199`, `src/js/main.js:1053-1061`, `src/js/main.js:1063-1079`, against
`src/js/main.js:257-278`
...
Confidence: Observed
Evidence: `src/js/main.js:1063-1079`, `src/js/main.js:2329-2335`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:299`, `src/js/main.js:1467-1485`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:359-365`, `src/js/main.js:2104-2112`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:155-168`, `src/js/main.js:257-278`, `src/index.html:13`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:161-168`
...
Confidence: Observed
Evidence: `src/js/main.js:1408-1418`, `src/js/main.js:1440-1445`
...
Confidence: Observed
Evidence: `src/js/main.js:1467-1485`, `src/index.html:299`
...
src/ returning no matches`, `src/js/main.js:558-586`,
...
Confidence: Observed
Evidence: `src/js/main.js:74`, `src/index.html:332-336`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1412-1418` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:224-225`, `PRODUCT_BACKLOG.md:1652-1655` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2059-2064`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1412-1418`.
