...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2459-2464` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:75-80`, `src/js/main.js:4041-4061`
...
Confidence: Observed
Evidence: `src/js/main.js:3377`, `src/js/main.js:1791-1799`, `src/js/main.js:1818-1834`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1818-1834`, `src/js/main.js:3691-3697`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:332`, `src/js/main.js:2490-2513`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:414-420`, `src/js/main.js:3282-3290`.
...
Confidence: Observed
Evidence: `src/js/main.js:2399-2404`, `src/js/main.js:2459-2464`
...
`src/styles.css:525`, `src/js/main.js:1690-1693`.
...
Confidence: Observed
Evidence: `src/js/main.js:2490-2513`, `src/index.html:332`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:380`, `src/styles.css:923-925`.
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2403-2404` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:368-369`, `PRODUCT_BACKLOG.md:10281` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:3243-3252`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2403-2404`.
