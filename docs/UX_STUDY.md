...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1729-1734` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:67-72`, `src/js/main.js:2829-2849`
...
Confidence: Observed
Evidence: `src/js/main.js:2500`, `src/js/main.js:1267-1275`, `src/js/main.js:1294-1310`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1294-1310`, `src/js/main.js:2713-2719`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:318`, `src/js/main.js:1760-1783`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:400-406`, `src/js/main.js:2405-2413`.
...
Confidence: Observed
Evidence: `src/js/main.js:1667-1677`, `src/js/main.js:1729-1734`
...
Confidence: Observed
Evidence: `src/js/main.js:1760-1783`, `src/index.html:318`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:248-249`, `PRODUCT_BACKLOG.md:3021-3024` | If sync existed and was opt-in, would you turn it on? |
