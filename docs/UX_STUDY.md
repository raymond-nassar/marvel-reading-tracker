...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1368-1373` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:61-66`, `src/js/main.js:2366-2379`
...
Confidence: Observed
Evidence: `src/js/main.js:2127`, `src/js/main.js:987-995`, `src/js/main.js:997-1013`, against
...
Confidence: Observed
Evidence: `src/js/main.js:997-1013`, `src/js/main.js:2257-2263`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:299`, `src/js/main.js:1395-1413`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:359-365`, `src/js/main.js:2032-2040`.
...
Confidence: Observed
Evidence: `src/js/main.js:1336-1346`, `src/js/main.js:1368-1373`
...
Confidence: Observed
Evidence: `src/js/main.js:1395-1413`, `src/index.html:299`
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1340-1346` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:213-214`, `PRODUCT_BACKLOG.md:1286-1289` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1987-1992`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1340-1346`.
