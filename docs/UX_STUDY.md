...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1332-1337` |
...
| 5 | Error prevention | 1 | Strong. Unreadable saved data pauses writing rather than overwriting, and a future schema is refused. `src/index.html:130-141`, `src/js/lib/model.js:400-426` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:61-66`, `src/js/main.js:2316-2329`
...
Confidence: Observed
Evidence: `src/js/main.js:2091`, `src/js/main.js:983-991`, `src/js/main.js:993-1009`, against
`src/js/main.js:243-264`
...
Confidence: Observed
Evidence: `src/js/main.js:993-1009`, `src/js/main.js:2210-2213`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:299`, `src/js/main.js:1359-1377`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:359-365`, `src/js/main.js:1996-2004`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:150-163`, `src/js/main.js:243-264`, `src/index.html:13`,
...
Confidence: Observed
Evidence: `src/js/main.js:1300-1310`, `src/js/main.js:1332-1337`
...
Confidence: Observed
Evidence: `src/js/main.js:1359-1377`, `src/index.html:299`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:248`, `src/styles.css:702-704`.
...
src/ returning no matches`, `src/js/main.js:519-547`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1304-1310` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:213-214`, `PRODUCT_BACKLOG.md:1247-1250` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1951-1956`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1304-1310`.
* When I have read half of a long order across several sittings, I want to come back and see where
  ...
  `src/js/main.js:2147-2165`.
* When my browser storage is cleared or I move machines, I want my progress back from a file I
  control, so I can keep my history without an account. Traced to `src/js/lib/model.js:477-501`.
