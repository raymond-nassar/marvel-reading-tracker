...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1717-1722` |
...
| 5 | Error prevention | 1 | Strong. Unreadable saved data pauses writing rather than overwriting, and a future schema is refused. `src/index.html:142-153`, `src/js/lib/model.js:509-535` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:67-72`, `src/js/main.js:2817-2837`
...
Confidence: Observed
Evidence: `src/js/main.js:2488`, `src/js/main.js:1267-1275`, `src/js/main.js:1294-1310`, against
`src/js/main.js:329-350`
...
Confidence: Observed
Evidence: `src/js/main.js:1294-1310`, `src/js/main.js:2701-2707`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:318`, `src/js/main.js:1748-1771`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:602-609`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:400-406`, `src/js/main.js:2393-2401`.
...
`src/styles.css:21-29`, `src/index.html:318`
...
`docs/ux-artifacts/pa11y-reading-seeded.json`, `src/index.html:291-326`
...
life of the product
Confidence: Measured
Evidence: `src/styles.css:619-620`, `docs/ux-artifacts/live-inspection.json`
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:227-240`, `src/js/main.js:329-350`, `src/index.html:17`,
`src/index.html:132`, `src/index.html:434`
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:233-240`
...
imported
Confidence: Measured
Evidence: `docs/ux-artifacts/pa11y-landing.json`, `src/index.html:291-326`
...
Confidence: Observed
Evidence: `src/js/main.js:1667-1677`, `src/js/main.js:1717-1722`
...
`src/styles.css:525`, `src/js/main.js:1229-1232`.
...
Confidence: Observed
Evidence: `src/js/main.js:1748-1771`, `src/index.html:318`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:380`, `src/styles.css:871-873`.
...
src/ returning no matches`, `src/js/main.js:711-742`,
...
Confidence: Observed
Evidence: `src/js/main.js:80`, `src/js/lib/readingFilters.js:25-48`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1671-1677` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:248-249`, `PRODUCT_BACKLOG.md:3011-3014` | If sync existed and was opt-in, would you turn it on? |
...
* When I finish an issue in the Marvel Unlimited reader, I want to mark it read and be shown the
  ...
  `src/index.html:291-326` and `src/index.html:318`.
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2348-2353`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1671-1677`.
* When I have read half of a long order across several sittings, I want to come back and see where
  ...
  `src/js/main.js:2570-2604`.
* When my browser storage is cleared or I move machines, I want my progress back from a file I
  control, so I can keep my history without an account. Traced to `src/js/lib/model.js:592-620`.
* When I follow one crossover, I want its progress counted for that list alone, so I can see how
  ...
  Hypothesis, and the gap behind existing story 4.2. Traced to `src/index.html:364-366`.
  Resolved: BL-014 scoped the count to the active list and put the choice in the view at
  `src/index.html:367-371`, with the subtitle naming whichever of the two is being counted.
...
| Checking progress | Opens Progress by series to see how far through the crossover they are | Confused. Counts include every other list they ever imported | Existing story 4.2, `src/index.html:364-366` |
