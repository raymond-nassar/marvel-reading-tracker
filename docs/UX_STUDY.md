...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:62-67`, `src/js/main.js:2493-2506`
...
Confidence: Observed
Evidence: `src/js/main.js:1064-1080`, `src/js/main.js:2377-2383`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:225-226`, `PRODUCT_BACKLOG.md:1788-1791` | If sync existed and was opt-in, would you turn it on? |
