...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1779-1784` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:67-72`, `src/js/main.js:2886-2906`
...
Confidence: Observed
Evidence: `src/js/main.js:2557`, `src/js/main.js:1282-1290`, `src/js/main.js:1309-1325`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1309-1325`, `src/js/main.js:2770-2776`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:318`, `src/js/main.js:1810-1833`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:400-406`, `src/js/main.js:2462-2470`.
...
Confidence: Observed
Evidence: `src/js/main.js:1717-1727`, `src/js/main.js:1779-1784`
...
`src/styles.css:525`, `src/js/main.js:1244-1247`.
...
Confidence: Observed
Evidence: `src/js/main.js:1810-1833`, `src/index.html:318`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:253-254`, `PRODUCT_BACKLOG.md:3177-3180` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2417-2422`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1721-1727`.
