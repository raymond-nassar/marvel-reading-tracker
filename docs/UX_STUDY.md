...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:77-82`, `src/js/main.js:4346-4366`
...
Confidence: Observed
Evidence: `src/js/main.js:3682`, `src/js/main.js:1837-1845`, `src/js/main.js:1864-1880`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1864-1880`, `src/js/main.js:3996-4002`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:418-424`, `src/js/main.js:3587-3595`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:380-381`, `PRODUCT_BACKLOG.md:10993` | If sync existed and was opt-in, would you turn it on? |
