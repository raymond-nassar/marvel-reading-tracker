...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2036-2041` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:72-77`, `src/js/main.js:3307-3327`
...
Confidence: Observed
Evidence: `src/js/main.js:2814`, `src/js/main.js:1473-1481`, `src/js/main.js:1500-1516`, against
`src/js/main.js:356-377`
...
Confidence: Observed
Evidence: `src/js/main.js:1500-1516`, `src/js/main.js:3040-3046`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:322`, `src/js/main.js:2067-2090`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:624-631`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:404-410`, `src/js/main.js:2719-2727`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:254-267`, `src/js/main.js:356-377`, `src/index.html:17`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:260-267`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:822-824`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:1971-1981`, `src/js/main.js:2036-2041`
...
`src/styles.css:525`, `src/js/main.js:1372-1375`.
...
Confidence: Observed
Evidence: `src/js/main.js:2067-2090`, `src/index.html:322`
...
src/ returning no matches`, `src/js/main.js:811-828`,
...
Confidence: Observed
Evidence: `src/js/main.js:85`, `src/js/lib/readingFilters.js:25-48`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1975-1981` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:303-304`, `PRODUCT_BACKLOG.md:5809` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2674-2679`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1975-1981`.
