...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:84-89`, `src/js/main.js:4748-4768`
...
Confidence: Observed
Evidence: `src/js/main.js:4037`, `src/js/main.js:2148-2156`, `src/js/main.js:2175-2191`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2175-2191`, `src/js/main.js:4398-4404`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:450-456`, `src/js/main.js:3942-3950`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:421-425`, `PRODUCT_BACKLOG.md:12294` | If sync existed and was opt-in, would you turn it on? |
