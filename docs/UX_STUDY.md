...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1685-1690` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:66-71`, `src/js/main.js:2768-2788`
...
Confidence: Observed
Evidence: `src/js/main.js:2440`, `src/js/main.js:1266-1274`, `src/js/main.js:1276-1292`, against
`src/js/main.js:328-349`
...
Confidence: Observed
Evidence: `src/js/main.js:1276-1292`, `src/js/main.js:2652-2658`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:311`, `src/js/main.js:1700-1723`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:393-399`, `src/js/main.js:2345-2353`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:226-239`, `src/js/main.js:328-349`, `src/index.html:17`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:232-239`
...
Confidence: Observed
Evidence: `src/js/main.js:1645-1655`, `src/js/main.js:1685-1690`
...
`src/styles.css:525`, `src/js/main.js:1228-1231`.
...
Confidence: Observed
Evidence: `src/js/main.js:1700-1723`, `src/index.html:311`
...
src/ returning no matches`, `src/js/main.js:710-741`,
...
Confidence: Observed
Evidence: `src/js/main.js:79`, `src/js/lib/readingFilters.js:25-48`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1649-1655` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:248-249`, `PRODUCT_BACKLOG.md:2966-2969` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2300-2305`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1649-1655`.
