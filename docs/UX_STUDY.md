...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:67-72`, `src/js/main.js:3107-3127`
...
Confidence: Observed
Evidence: `src/js/main.js:2778`, `src/js/main.js:1442-1450`, `src/js/main.js:1469-1485`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1469-1485`, `src/js/main.js:2991-2997`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:318`, `src/js/main.js:2031-2054`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:400-406`, `src/js/main.js:2683-2691`.
...
selected before the shot is taken, because the landing page puts `aria-current` on the brand rather
than on any rail item, so a capture of the page as it first loads photographs a bar that is not
rendered and passes for a picture of nothing.
...
Confidence: Observed
Evidence: `src/js/main.js:1935-1945`, `src/js/main.js:2000-2005`
...
Confidence: Observed
Evidence: `src/js/main.js:2031-2054`, `src/index.html:318`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:259-260`, `PRODUCT_BACKLOG.md:3824-3827` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2638-2643`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1939-1945`.
