...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:74-79`, `src/js/main.js:3573-3593`
...
Confidence: Observed
Evidence: `src/js/main.js:1605-1621`, `src/js/main.js:3275-3281`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:351-352`, `PRODUCT_BACKLOG.md:8344` | If sync existed and was opt-in, would you turn it on? |
