...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1994-1999` |
...
| 5 | Error prevention | 1 | Strong. Unreadable saved data pauses writing rather than overwriting, and a future schema is refused. `src/index.html:142-153`, `src/js/lib/model.js:582-608` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:67-72`, `src/js/main.js:3101-3121`
...
Confidence: Observed
Evidence: `src/js/main.js:2772`, `src/js/main.js:1442-1450`, `src/js/main.js:1469-1485`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1469-1485`, `src/js/main.js:2985-2991`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:318`, `src/js/main.js:2025-2048`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:400-406`, `src/js/main.js:2677-2685`.
...
Confidence: Observed
Evidence: `src/js/main.js:1929-1939`, `src/js/main.js:1994-1999`
...
`src/styles.css:525`, `src/js/main.js:1341-1344`.
...
Confidence: Observed
Evidence: `src/js/main.js:2025-2048`, `src/index.html:318`
...
src/ returning no matches`, `src/js/main.js:784-801`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1933-1939` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:257-258`, `PRODUCT_BACKLOG.md:3714-3717` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2632-2637`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1933-1939`.
* When I have read half of a long order across several sittings, I want to come back and see where
  ...
  `src/js/main.js:2854-2888`.
* When my browser storage is cleared or I move machines, I want my progress back from a file I
  control, so I can keep my history without an account. Traced to `src/js/lib/model.js:671-699`.
