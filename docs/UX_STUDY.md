...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1121-1126` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:53-58`, `src/js/main.js:2069-2082`
...
Confidence: Observed
Evidence: `src/js/main.js:1859`, `src/js/main.js:841-851`, `src/js/main.js:848-854`, against
`src/js/main.js:130-142`
...
Confidence: Observed
Evidence: `src/js/main.js:848-854`, `src/js/main.js:1963-1966`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:281`, `src/js/main.js:1148-1166`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:341-347`, `src/js/main.js:1773-1781`.
...
`src/styles.css:20-29`, `src/index.html:281`
...
`docs/ux-artifacts/pa11y-reading-seeded.json`, `src/index.html:259-289`
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:130-142`, `src/index.html:13`, `src/index.html:120`,
`src/index.html:369`
...
imported
Confidence: Measured
Evidence: `docs/ux-artifacts/pa11y-landing.json`, `src/index.html:259-289`
...
Confidence: Observed
Evidence: `src/js/main.js:1094`, `src/js/main.js:1121-1126`
...
`src/styles.css:393`, `src/index.html:314-318`.
...
Confidence: Observed
Evidence: `src/js/main.js:1148-1166`, `src/index.html:281`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:248`, `src/styles.css:675-677`.
...
src/ returning no matches`, `src/js/main.js:381-405`,
...
Confidence: Observed
Evidence: `src/js/main.js:61`, `src/index.html:314-318`
Source: Step 5 information architecture review, addressability
...
| Reading style | Follows a long curated order end to end rather than dipping in | Strong. The product is built around order, resume and next-unread rather than around browsing. `src/index.html:259-289` | When a list is abandoned partway, what caused it? |
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1096-1099` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:213-214`, `PRODUCT_BACKLOG.md:1016-1019` | If sync existed and was opt-in, would you turn it on? |
...
* When I finish an issue in the Marvel Unlimited reader, I want to mark it read and be shown the
  ...
  `src/index.html:259-289` and `src/index.html:281`.
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1728-1733`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1096-1099`.
...
* When I follow one crossover, I want its progress counted for that list alone, so I can see how
  ...
  Hypothesis, and the gap behind existing story 4.2. Traced to `src/index.html:328-330`.
...
| Checking progress | Opens Progress by series to see how far through the crossover they are | Confused. Counts include every other list they ever imported | Existing story 4.2, `src/index.html:328-330` |
