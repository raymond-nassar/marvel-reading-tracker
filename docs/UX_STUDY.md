...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2013-2018` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:72-77`, `src/js/main.js:3120-3140`
...
Confidence: Observed
Evidence: `src/js/main.js:2791`, `src/js/main.js:1450-1458`, `src/js/main.js:1477-1493`, against
`src/js/main.js:337-358`
...
Confidence: Observed
Evidence: `src/js/main.js:1477-1493`, `src/js/main.js:3004-3010`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:322`, `src/js/main.js:2044-2067`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:606-613`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:404-410`, `src/js/main.js:2696-2704`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:235-248`, `src/js/main.js:337-358`, `src/index.html:17`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:241-248`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:803-805`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:1948-1958`, `src/js/main.js:2013-2018`
...
`src/styles.css:525`, `src/js/main.js:1349-1352`.
...
Confidence: Observed
Evidence: `src/js/main.js:2044-2067`, `src/index.html:322`
...
src/ returning no matches`, `src/js/main.js:792-809`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1952-1958` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:261-262`, `PRODUCT_BACKLOG.md:4365` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2651-2656`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1952-1958`.
