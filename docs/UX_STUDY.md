...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:262-263`, `PRODUCT_BACKLOG.md:4136` | If sync existed and was opt-in, would you turn it on? |
