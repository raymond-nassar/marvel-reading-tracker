...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2032-2037` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:72-77`, `src/js/main.js:3139-3159`
...
Confidence: Observed
Evidence: `src/js/main.js:2810`, `src/js/main.js:1469-1477`, `src/js/main.js:1496-1512`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1496-1512`, `src/js/main.js:3023-3029`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:322`, `src/js/main.js:2063-2086`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:404-410`, `src/js/main.js:2715-2723`.
...
Confidence: Observed
Evidence: `src/js/main.js:1967-1977`, `src/js/main.js:2032-2037`
...
`src/styles.css:525`, `src/js/main.js:1368-1371`.
...
Confidence: Observed
Evidence: `src/js/main.js:2063-2086`, `src/index.html:322`
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1971-1977` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:264-265`, `PRODUCT_BACKLOG.md:4749` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2670-2675`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1971-1977`.
