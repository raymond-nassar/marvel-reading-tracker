...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2234-2239` |
...
| 5 | Error prevention | 1 | Strong. Unreadable saved data pauses writing rather than overwriting, and a future schema is refused. `src/index.html:146-161`, `src/js/lib/model.js:830-906` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:74-79`, `src/js/main.js:3679-3699`
...
Confidence: Observed
Evidence: `src/js/main.js:3028`, `src/js/main.js:1578-1586`, `src/js/main.js:1605-1621`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1605-1621`, `src/js/main.js:3342-3348`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:326`, `src/js/main.js:2265-2288`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:633-640`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:408-414`, `src/js/main.js:2933-2941`.
...
`src/styles.css:21-29`, `src/index.html:326`
...
`docs/ux-artifacts/pa11y-reading-seeded.json`, `src/index.html:299-334`
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:329-342`, `src/js/main.js:431-452`, `src/index.html:21`,
`src/index.html:136`, `src/index.html:442`
...
imported
Confidence: Measured
Evidence: `docs/ux-artifacts/pa11y-landing.json`, `src/index.html:299-334`
...
Confidence: Observed
Evidence: `src/js/main.js:2174-2179`, `src/js/main.js:2234-2239`
...
`src/styles.css:525`, `src/js/main.js:1477-1480`.
...
Confidence: Observed
Evidence: `src/js/main.js:2265-2288`, `src/index.html:326`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:380`, `src/styles.css:901-903`.
...
Confidence: Observed
Evidence: `src/js/main.js:100`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Reading style | Follows a long curated order end to end rather than dipping in | Strong. The product is built around order, resume and next-unread rather than around browsing. `src/index.html:299-334` | When a list is abandoned partway, what caused it? |
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2178-2179` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:360-361`, `PRODUCT_BACKLOG.md:9782` | If sync existed and was opt-in, would you turn it on? |
...
* When I finish an issue in the Marvel Unlimited reader, I want to mark it read and be shown the
  ...
  `src/index.html:299-334` and `src/index.html:326`.
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2888-2893`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2178-2179`.
* When I have read half of a long order across several sittings, I want to come back and see where
  ...
  `src/js/main.js:3115-3149`.
* When my browser storage is cleared or I move machines, I want my progress back from a file I
  control, so I can keep my history without an account. Traced to `src/js/lib/model.js:988-1019`.
* When I follow one crossover, I want its progress counted for that list alone, so I can see how
  ...
  Hypothesis, and the gap behind existing story 4.2. Traced to `src/index.html:372-374`.
  Resolved: BL-014 scoped the count to the active list and put the choice in the view at
  `src/index.html:375-379`, with the subtitle naming whichever of the two is being counted.
...
| Checking progress | Opens Progress by series to see how far through the crossover they are | Confused. Counts include every other list they ever imported | Existing story 4.2, `src/index.html:372-374` |
