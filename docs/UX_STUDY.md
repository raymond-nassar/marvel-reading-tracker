...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:76-81`, `src/js/main.js:4265-4285`
...
Confidence: Observed
Evidence: `src/js/main.js:3601`, `src/js/main.js:1836-1844`, `src/js/main.js:1863-1879`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1863-1879`, `src/js/main.js:3915-3921`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:418-424`, `src/js/main.js:3506-3514`.
...
strikethrough, at `src/styles.css:577-578`. The only opacity left on a read row is on the cover
image at `src/styles.css:580`, which carries no text. Re-measured with six rows actually in the
...
life of the product
Confidence: Measured
Evidence: `src/styles.css:649-650`, `docs/ux-artifacts/live-inspection.json`
...
`src/styles.css:525`, `src/js/main.js:1735-1738`.
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:380`, `src/styles.css:935-937`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:376-377`, `PRODUCT_BACKLOG.md:10763` | If sync existed and was opt-in, would you turn it on? |
