...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:84-89`, `src/js/main.js:4735-4755`
...
Confidence: Observed
Evidence: `src/js/main.js:2175-2191`, `src/js/main.js:4385-4391`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:404-405`, `PRODUCT_BACKLOG.md:11825` | If sync existed and was opt-in, would you turn it on? |
