...
blocking
Confidence: Observed
Evidence: `src/js/main.js:337-350`, `src/js/main.js:477-485`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:344-349`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:397`, `src/styles.css:971-974`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:385-389`, `PRODUCT_BACKLOG.md:11206` | If sync existed and was opt-in, would you turn it on? |
