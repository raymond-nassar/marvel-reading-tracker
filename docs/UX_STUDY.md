...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:75-80`, `src/js/main.js:3863-3883`
...
Confidence: Observed
Evidence: `src/js/main.js:3199`, `src/js/main.js:1644-1652`, `src/js/main.js:1671-1687`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1671-1687`, `src/js/main.js:3513-3519`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:410-416`, `src/js/main.js:3104-3112`.
...
Confidence: Observed
Evidence: `src/js/main.js:2252-2257`, `src/js/main.js:2312-2317`
...
`src/styles.css:525`, `src/js/main.js:1543-1546`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:361-362`, `PRODUCT_BACKLOG.md:9773` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:3059-3064`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2256-2257`.
