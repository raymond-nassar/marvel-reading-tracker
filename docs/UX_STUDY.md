...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2559-2564` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:77-82`, `src/js/main.js:4406-4426`
...
Confidence: Observed
Evidence: `src/js/main.js:3742`, `src/js/main.js:1875-1883`, `src/js/main.js:1902-1918`, against
`src/js/main.js:467-488`
...
Confidence: Observed
Evidence: `src/js/main.js:1902-1918`, `src/js/main.js:4056-4062`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:336`, `src/js/main.js:2590-2613`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:418-424`, `src/js/main.js:3647-3655`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:337-350`, `src/js/main.js:467-488`, `src/index.html:21`,
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1010-1012`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2499-2504`, `src/js/main.js:2559-2564`
...
`src/styles.css:542`, `src/js/main.js:1774-1777`.
...
Confidence: Observed
Evidence: `src/js/main.js:2590-2613`, `src/index.html:336`
...
src/ returning no matches`, `src/js/main.js:999-1016`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2503-2504` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:383-384`, `PRODUCT_BACKLOG.md:11143` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:3567-3584`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2503-2504`.
