...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2504-2509` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:76-81`, `src/js/main.js:4147-4167`
...
Confidence: Observed
Evidence: `src/js/main.js:3483`, `src/js/main.js:1836-1844`, `src/js/main.js:1863-1879`, against
`src/js/main.js:438-459`
...
Confidence: Observed
Evidence: `src/js/main.js:1863-1879`, `src/js/main.js:3797-3803`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:336`, `src/js/main.js:2535-2558`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:649-656`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:418-424`, `src/js/main.js:3388-3396`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:336-349`, `src/js/main.js:438-459`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:342-349`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:977-979`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2444-2449`, `src/js/main.js:2504-2509`
...
`src/styles.css:542`, `src/js/main.js:1735-1738`.
...
Confidence: Observed
Evidence: `src/js/main.js:2535-2558`, `src/index.html:336`
...
src/ returning no matches`, `src/js/main.js:966-983`,
...
Confidence: Observed
Evidence: `src/js/main.js:107`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2448-2449` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:380-381`, `PRODUCT_BACKLOG.md:10850` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:3308-3325`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2448-2449`.
