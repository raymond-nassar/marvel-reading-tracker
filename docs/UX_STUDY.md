...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1517-1522` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:62-67`, `src/js/main.js:2561-2574`
...
Confidence: Observed
Evidence: `src/js/main.js:2284`, `src/js/main.js:1098-1106`, `src/js/main.js:1108-1124`, against
`src/js/main.js:302-323`
...
Confidence: Observed
Evidence: `src/js/main.js:1108-1124`, `src/js/main.js:2445-2451`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:299`, `src/js/main.js:1544-1567`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:555-562`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:364-370`, `src/js/main.js:2189-2197`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:200-213`, `src/js/main.js:302-323`, `src/index.html:13`,
`src/index.html:120`, `src/index.html:398`
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:206-213`
...
Confidence: Observed
Evidence: `src/js/main.js:1477-1487`, `src/js/main.js:1517-1522`
...
`src/styles.css:393`, `src/index.html:332-336`.
...
Confidence: Observed
Evidence: `src/js/main.js:1544-1567`, `src/index.html:299`
...
src/ returning no matches`, `src/js/main.js:603-631`,
...
Confidence: Observed
Evidence: `src/js/main.js:75`, `src/index.html:332-336`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1481-1487` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:238-239`, `PRODUCT_BACKLOG.md:2036-2039` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2144-2149`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1481-1487`.
...
* When I follow one crossover, I want its progress counted for that list alone, so I can see how
  ...
  Hypothesis, and the gap behind existing story 4.2. Traced to `src/index.html:346-348`.
  Resolved: BL-014 scoped the count to the active list and put the choice in the view at
  `src/index.html:349-353`, with the subtitle naming whichever of the two is being counted.
...
| Checking progress | Opens Progress by series to see how far through the crossover they are | Confused. Counts include every other list they ever imported | Existing story 4.2, `src/index.html:346-348` |
