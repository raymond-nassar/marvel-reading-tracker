...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2105-2110` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:73-78`, `src/js/main.js:3394-3414`
...
Confidence: Observed
Evidence: `src/js/main.js:2883`, `src/js/main.js:1502-1510`, `src/js/main.js:1529-1545`, against
`src/js/main.js:370-391`
...
Confidence: Observed
Evidence: `src/js/main.js:1529-1545`, `src/js/main.js:3118-3124`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:322`, `src/js/main.js:2136-2159`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:404-410`, `src/js/main.js:2788-2796`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:268-281`, `src/js/main.js:370-391`, `src/index.html:17`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:274-281`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:836-838`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2040-2050`, `src/js/main.js:2105-2110`
...
`src/styles.css:525`, `src/js/main.js:1401-1404`.
...
Confidence: Observed
Evidence: `src/js/main.js:2136-2159`, `src/index.html:322`
...
src/ returning no matches`, `src/js/main.js:825-842`,
...
Confidence: Observed
Evidence: `src/js/main.js:99`, `src/js/lib/readingFilters.js:25-48`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2044-2050` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:337-338`, `PRODUCT_BACKLOG.md:7335` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2743-2748`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2044-2050`.
