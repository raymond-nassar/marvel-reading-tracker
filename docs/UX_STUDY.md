...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1821-1826` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:67-72`, `src/js/main.js:2928-2948`
...
Confidence: Observed
Evidence: `src/js/main.js:2599`, `src/js/main.js:1324-1332`, `src/js/main.js:1351-1367`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1351-1367`, `src/js/main.js:2812-2818`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:318`, `src/js/main.js:1852-1875`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:400-406`, `src/js/main.js:2504-2512`.
...
Confidence: Observed
Evidence: `src/js/main.js:1759-1769`, `src/js/main.js:1821-1826`
...
`src/styles.css:525`, `src/js/main.js:1285-1288`.
...
Confidence: Observed
Evidence: `src/js/main.js:1852-1875`, `src/index.html:318`
...
src/ returning no matches`, `src/js/main.js:730-761`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1763-1769` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:252-253`, `PRODUCT_BACKLOG.md:3259-3262` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2459-2464`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1763-1769`.
