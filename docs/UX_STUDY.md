...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2300-2305` |
...
| 5 | Error prevention | 1 | Strong. Unreadable saved data pauses writing rather than overwriting, and a future schema is refused. `src/index.html:142-157`, `src/js/lib/model.js:879-955` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:75-80`, `src/js/main.js:3812-3832`
...
Confidence: Observed
Evidence: `src/js/main.js:3161`, `src/js/main.js:1636-1644`, `src/js/main.js:1663-1679`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1663-1679`, `src/js/main.js:3475-3481`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:328`, `src/js/main.js:2331-2354`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:410-416`, `src/js/main.js:3066-3074`.
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:968-970`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2240-2245`, `src/js/main.js:2300-2305`
...
`src/styles.css:525`, `src/js/main.js:1535-1538`.
...
Confidence: Observed
Evidence: `src/js/main.js:2331-2354`, `src/index.html:328`
...
src/ returning no matches`, `src/js/main.js:957-974`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2244-2245` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:358-359`, `PRODUCT_BACKLOG.md:9680` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:3021-3026`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2244-2245`.
* When I have read half of a long order across several sittings, I want to come back and see where
  ...
  `src/js/main.js:3248-3282`.
* When my browser storage is cleared or I move machines, I want my progress back from a file I
  control, so I can keep my history without an account. Traced to `src/js/lib/model.js:1037-1068`.
