...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:62-67`, `src/js/main.js:2495-2508`
...
Confidence: Observed
Evidence: `src/js/main.js:1064-1080`, `src/js/main.js:2379-2385`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:364-370`, `src/js/main.js:2123-2131`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:156-169`, `src/js/main.js:258-279`, `src/index.html:13`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:162-169`
...
src/ returning no matches`, `src/js/main.js:559-587`,
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:233-234`, `PRODUCT_BACKLOG.md:1859-1862` | If sync existed and was opt-in, would you turn it on? |
