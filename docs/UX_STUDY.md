...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:439`, `src/styles.css:1081-1083`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:403-404`, `PRODUCT_BACKLOG.md:11764` | If sync existed and was opt-in, would you turn it on? |
