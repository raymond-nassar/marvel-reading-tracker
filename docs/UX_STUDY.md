...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2503-2508` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:75-80`, `src/js/main.js:4089-4109`
...
Confidence: Observed
Evidence: `src/js/main.js:3425`, `src/js/main.js:1835-1843`, `src/js/main.js:1862-1878`, against
`src/js/main.js:437-458`
...
Confidence: Observed
Evidence: `src/js/main.js:1862-1878`, `src/js/main.js:3739-3745`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:336`, `src/js/main.js:2534-2557`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:418-424`, `src/js/main.js:3330-3338`.
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:341-348`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:976-978`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2443-2448`, `src/js/main.js:2503-2508`
...
`src/styles.css:525`, `src/js/main.js:1734-1737`.
...
Confidence: Observed
Evidence: `src/js/main.js:2534-2557`, `src/index.html:336`
...
src/ returning no matches`, `src/js/main.js:965-982`,
...
Confidence: Observed
Evidence: `src/js/main.js:106`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2447-2448` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:371-372`, `PRODUCT_BACKLOG.md:10456` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:3287-3300`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2447-2448`.
