...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1735-1740` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:66-71`, `src/js/main.js:2825-2845`
...
Confidence: Observed
Evidence: `src/js/main.js:2497`, `src/js/main.js:1281-1289`, `src/js/main.js:1291-1307`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1291-1307`, `src/js/main.js:2709-2715`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:311`, `src/js/main.js:1750-1773`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:393-399`, `src/js/main.js:2402-2410`.
...
Confidence: Observed
Evidence: `src/js/main.js:1695-1705`, `src/js/main.js:1735-1740`
...
`src/styles.css:525`, `src/js/main.js:1243-1246`.
...
Confidence: Observed
Evidence: `src/js/main.js:1750-1773`, `src/index.html:311`
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1699-1705` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:249-250`, `PRODUCT_BACKLOG.md:3033-3036` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2357-2362`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1699-1705`.
