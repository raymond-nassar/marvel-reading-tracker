...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1932-1937` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:67-72`, `src/js/main.js:3039-3059`
...
Confidence: Observed
Evidence: `src/js/main.js:2710`, `src/js/main.js:1435-1443`, `src/js/main.js:1462-1478`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1462-1478`, `src/js/main.js:2923-2929`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:318`, `src/js/main.js:1963-1986`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:400-406`, `src/js/main.js:2615-2623`.
...
Confidence: Observed
Evidence: `src/js/main.js:1870-1880`, `src/js/main.js:1932-1937`
...
Confidence: Observed
Evidence: `src/js/main.js:1963-1986`, `src/index.html:318`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:254-255`, `PRODUCT_BACKLOG.md:3524-3527` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2570-2575`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1874-1880`.
