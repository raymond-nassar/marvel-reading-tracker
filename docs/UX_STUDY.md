...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1864-1869` |
...
| 5 | Error prevention | 1 | Strong. Unreadable saved data pauses writing rather than overwriting, and a future schema is refused. `src/index.html:142-153`, `src/js/lib/model.js:563-589` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:67-72`, `src/js/main.js:2971-2991`
...
Confidence: Observed
Evidence: `src/js/main.js:2642`, `src/js/main.js:1367-1375`, `src/js/main.js:1394-1410`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1394-1410`, `src/js/main.js:2855-2861`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:318`, `src/js/main.js:1895-1918`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:400-406`, `src/js/main.js:2547-2555`.
...
Confidence: Observed
Evidence: `src/js/main.js:1802-1812`, `src/js/main.js:1864-1869`
...
`src/styles.css:525`, `src/js/main.js:1303-1306`.
...
Confidence: Observed
Evidence: `src/js/main.js:1895-1918`, `src/index.html:318`
...
src/ returning no matches`, `src/js/main.js:746-763`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1806-1812` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:253-254`, `PRODUCT_BACKLOG.md:3349-3352` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2502-2507`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1806-1812`.
* When I have read half of a long order across several sittings, I want to come back and see where
  ...
  `src/js/main.js:2724-2758`.
* When my browser storage is cleared or I move machines, I want my progress back from a file I
  control, so I can keep my history without an account. Traced to `src/js/lib/model.js:652-680`.
