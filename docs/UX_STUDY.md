...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2499-2504` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:75-80`, `src/js/main.js:4085-4105`
...
Confidence: Observed
Evidence: `src/js/main.js:3421`, `src/js/main.js:1831-1839`, `src/js/main.js:1858-1874`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1858-1874`, `src/js/main.js:3735-3741`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:336`, `src/js/main.js:2530-2553`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:418-424`, `src/js/main.js:3326-3334`.
...
Confidence: Observed
Evidence: `src/js/main.js:2439-2444`, `src/js/main.js:2499-2504`
...
`src/styles.css:525`, `src/js/main.js:1730-1733`.
...
Confidence: Observed
Evidence: `src/js/main.js:2530-2553`, `src/index.html:336`
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2443-2444` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:3283-3296`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2443-2444`.
