...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:75-80`, `src/js/main.js:3889-3909`
...
Confidence: Observed
Evidence: `src/js/main.js:3225`, `src/js/main.js:1644-1652`, `src/js/main.js:1671-1687`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1671-1687`, `src/js/main.js:3539-3545`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:367-368`, `PRODUCT_BACKLOG.md:10208` | If sync existed and was opt-in, would you turn it on? |
