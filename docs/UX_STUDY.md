...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2153-2158` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:74-79`, `src/js/main.js:3468-3488`
...
Confidence: Observed
Evidence: `src/js/main.js:2947`, `src/js/main.js:1544-1552`, `src/js/main.js:1571-1587`, against
`src/js/main.js:399-420`
...
Confidence: Observed
Evidence: `src/js/main.js:1571-1587`, `src/js/main.js:3181-3187`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:322`, `src/js/main.js:2184-2207`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:404-410`, `src/js/main.js:2852-2860`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:297-310`, `src/js/main.js:399-420`, `src/index.html:17`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:303-310`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:878-880`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2088-2098`, `src/js/main.js:2153-2158`
...
`src/styles.css:525`, `src/js/main.js:1443-1446`.
...
Confidence: Observed
Evidence: `src/js/main.js:2184-2207`, `src/index.html:322`
...
src/ returning no matches`, `src/js/main.js:867-884`,
...
Confidence: Observed
Evidence: `src/js/main.js:100`, `src/js/lib/readingFilters.js:25-48`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2092-2098` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:348-349`, `PRODUCT_BACKLOG.md:8276` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2807-2812`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2092-2098`.
