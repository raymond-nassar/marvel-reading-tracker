...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:76-81`, `src/js/main.js:4158-4178`
...
Confidence: Observed
Evidence: `src/js/main.js:3494`, `src/js/main.js:1836-1844`, `src/js/main.js:1863-1879`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1863-1879`, `src/js/main.js:3808-3814`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:418-424`, `src/js/main.js:3399-3407`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:380-381`, `PRODUCT_BACKLOG.md:10885` | If sync existed and was opt-in, would you turn it on? |
