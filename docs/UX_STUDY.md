...
blocked one
Confidence: Observed
Evidence: `src/index.html:322`, `src/js/main.js:2031-2054`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:404-410`, `src/js/main.js:2683-2691`.
...
Confidence: Observed
Evidence: `src/js/main.js:2031-2054`, `src/index.html:322`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:261-262`, `PRODUCT_BACKLOG.md:3947` | If sync existed and was opt-in, would you turn it on? |
