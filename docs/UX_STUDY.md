...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:607-612` |
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:207-213`, `src/js/main.js:1259-1263`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:139-144`, `src/index.html:13`, `src/index.html:64`,
`src/index.html:235`
...
Confidence: Observed
Evidence: `src/js/main.js:580`, `src/js/main.js:607-612`
...
src/ returning no matches`, `src/js/main.js:267-287`,
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:211-212`, `PRODUCT_BACKLOG.md:885-888` | If sync existed and was opt-in, would you turn it on? |
