...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2187-2192` |
...
| 5 | Error prevention | 1 | Strong. Unreadable saved data pauses writing rather than overwriting, and a future schema is refused. `src/index.html:142-157`, `src/js/lib/model.js:769-845` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:74-79`, `src/js/main.js:3626-3646`
...
Confidence: Observed
Evidence: `src/js/main.js:2981`, `src/js/main.js:1578-1586`, `src/js/main.js:1605-1621`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1605-1621`, `src/js/main.js:3289-3295`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:322`, `src/js/main.js:2218-2241`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:404-410`, `src/js/main.js:2886-2894`.
...
Confidence: Observed
Evidence: `src/js/main.js:2122-2132`, `src/js/main.js:2187-2192`
...
Confidence: Observed
Evidence: `src/js/main.js:2218-2241`, `src/index.html:322`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:353-354`, `PRODUCT_BACKLOG.md:8628` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2841-2846`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2126-2132`.
* When I have read half of a long order across several sittings, I want to come back and see where
  ...
  `src/js/main.js:3062-3096`.
* When my browser storage is cleared or I move machines, I want my progress back from a file I
  control, so I can keep my history without an account. Traced to `src/js/lib/model.js:927-958`.
