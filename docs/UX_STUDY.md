...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:72-77`, `src/js/main.js:3294-3314`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:287-288`, `PRODUCT_BACKLOG.md:5291` | If sync existed and was opt-in, would you turn it on? |
