...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:75-80`, `src/js/main.js:3876-3896`
...
Confidence: Observed
Evidence: `src/js/main.js:3212`, `src/js/main.js:1644-1652`, `src/js/main.js:1671-1687`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1671-1687`, `src/js/main.js:3526-3532`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:410-416`, `src/js/main.js:3117-3125`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:361-362`, `PRODUCT_BACKLOG.md:9790` | If sync existed and was opt-in, would you turn it on? |
