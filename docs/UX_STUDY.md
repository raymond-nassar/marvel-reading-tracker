...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:75-80`, `src/js/main.js:4105-4125`
...
Confidence: Observed
Evidence: `src/js/main.js:3441`, `src/js/main.js:1835-1843`, `src/js/main.js:1862-1878`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1862-1878`, `src/js/main.js:3755-3761`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:418-424`, `src/js/main.js:3346-3354`.
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:376-377`, `PRODUCT_BACKLOG.md:10667` | If sync existed and was opt-in, would you turn it on? |
