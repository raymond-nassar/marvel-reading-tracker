...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:1692-1697` |
...
| 5 | Error prevention | 1 | Strong. Unreadable saved data pauses writing rather than overwriting, and a future schema is refused. `src/index.html:142-153`, `src/js/lib/model.js:519-545` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:65-70`, `src/js/main.js:2782-2797`
...
Confidence: Observed
Evidence: `src/js/main.js:2454`, `src/js/main.js:1238-1246`, `src/js/main.js:1248-1264`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1248-1264`, `src/js/main.js:2666-2672`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:311`, `src/js/main.js:1707-1730`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:393-399`, `src/js/main.js:2359-2367`.
...
life of the product
Confidence: Measured
Evidence: `src/styles.css:614-615`, `docs/ux-artifacts/live-inspection.json`
...
Confidence: Observed
Evidence: `src/js/main.js:1652-1662`, `src/js/main.js:1692-1697`
...
`src/styles.css:525`, `src/js/main.js:1200-1203`.
...
Confidence: Observed
Evidence: `src/js/main.js:1707-1730`, `src/index.html:311`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:380`, `src/styles.css:865-867`.
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:1656-1662` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:248-249`, `PRODUCT_BACKLOG.md:2960-2963` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2314-2319`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:1656-1662`.
