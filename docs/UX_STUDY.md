...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:72-77`, `src/js/main.js:3303-3323`
...
Confidence: Observed
Evidence: `src/js/main.js:1500-1516`, `src/js/main.js:3036-3042`
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:288-289`, `PRODUCT_BACKLOG.md:5325` | If sync existed and was opt-in, would you turn it on? |
