...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2072-2077` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:73-78`, `src/js/main.js:3352-3372`
...
Confidence: Observed
Evidence: `src/js/main.js:2850`, `src/js/main.js:1489-1497`, `src/js/main.js:1516-1532`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1516-1532`, `src/js/main.js:3076-3082`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:322`, `src/js/main.js:2103-2126`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:404-410`, `src/js/main.js:2755-2763`.
...
Confidence: Observed
Evidence: `src/js/main.js:2007-2017`, `src/js/main.js:2072-2077`
...
Confidence: Observed
Evidence: `src/js/main.js:2103-2126`, `src/index.html:322`
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2011-2017` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:332-333`, `PRODUCT_BACKLOG.md:6744` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2710-2715`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2011-2017`.
