...
// stated as text beside it, at `src/js/main.js:1033` in the rail and `src/js/main.js:1174` in the
// saved lists.
//
...
export const KNOWN = [
  ...
  // the button takes its accessible name from the `aria-label` at `src/js/main.js:2224`, which
  // replaces the glyph in the name computation, and `aria-pressed` at `src/js/main.js:2223`
