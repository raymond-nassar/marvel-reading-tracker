...
export const KNOWN = [
  ...
  // the button takes its accessible name from the `aria-label` at `src/js/main.js:1991`, which
  // replaces the glyph in the name computation, and `aria-pressed` at `src/js/main.js:1990`
