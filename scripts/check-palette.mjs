...
// stated as text beside it, at `src/js/main.js:885` in the rail and `src/js/main.js:1021` in the
// saved lists.
//
...
export const KNOWN = [
  ...
  // the button takes its accessible name from the `aria-label` at `src/js/main.js:1955`, which
  // replaces the glyph in the name computation, and `aria-pressed` at `src/js/main.js:1954`
