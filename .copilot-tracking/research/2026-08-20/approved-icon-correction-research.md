...
| C3 | The backlog implementation record owns the shipped icon description and its one-source contract. | PRODUCT_BACKLOG.md:11113-11117 | read | high | Current product evidence must describe the corrected mark. |
